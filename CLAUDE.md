...
│   ├── scenario_optimiste.md              # Scénario A — Accord durable / sortie de crise (bornes de probabilité dans la synthèse J* courante, non figées ici — anti-ancrage)
│   ├── scenario_realiste.md               # Scénario B — Enlisement / accord creux
│   ├── scenario_pessimiste.md             # Scénario C — Escalade / choc physique
│   ├── calendrier_penuries.md             # Échéancier prévisionnel des phases de tension par produit (Édition 3.0 : fenêtre S29→S40, trajectoire centrale = scénario modal courant, bornes en Annexe C)
...
│   ├── pertes_humaines_materielles.md     # Recensement documenté des pertes humaines et matérielles J1→J144 (fourchettes + cotes + statuts confirmé/rapporté/revendiqué ; fait foi sur les pertes ; mis à jour à chaque synthèse périodique)
│   ├── infrastructures_europe.md          # Tables raffineries, dépôts, ports, UGS, GNL, pipelines + days of cover par pays
│   ├── synthese_J142-J144.md              # Dernière synthèse périodique (fait foi sur l'état courant) — le prix a parlé, l'offensive n'est pas venue : Brent franchit 90 $ à quatre reprises (haut 91,49 $, plus haut depuis le 10 juin) mais sans jamais clôturer au-dessus ni approcher 100 $ (2e déclencheur de « C franc » franchi EN NIVEAU, pas EN DURÉE → non tranché) ; ultimatum Rezaei échu SANS offensive de grande échelle (reclassé de lacune de collecte en fait négatif documenté) — mais effondrement des transits d'Ormuz (7/jour puis aucun navire observé le 21/7, −66 % hebdo), JMIC relevé de « SEVERE » à « CRITICAL », 10e navire frappé (tanker koweïtien Kaifan), 9e-10e nuits CENTCOM, blocus naval houthi DÉCLARÉ contre l'Arabie saoudite (non exécuté, 3e chokepoint menacé) ; contre-poids : trêve de 10 jours proposée par Qatar/Égypte/Oman/Pakistan, acceptée par personne ; pertes US 17 morts + 1 disparu / ~447 blessés mais 3e mort HORS feu iranien (sous-compte maintenu à 2) ; 1er incident direct France-Iran (2 diplomates molestés à Téhéran) ; gazole France 2,117-2,139 €/L sans pénurie, moyenne DGEC introuvable pour la 2e fois consécutive + recalibrage A 3-8 / B 20-28 / C 64-72 (C modal, médiane ~68)
│   ├── synthese_J141-J142.md              # Synthèse périodique précédente (archivée) — le seuil militaire franchi : 2 militaires US tués + 1 disparu sous le feu iranien (base Muwaffaq Salti, Jordanie, 17/7 — 1er des 2 déclencheurs de « C franc »), 8e nuit de frappes CENTCOM en représailles (ponts/rail Hormozgan), MOU d'Islamabad formellement suspendu par Téhéran (18/7), 4 militaires koweïtiens blessés en mer — mais marché fermé (Brent figé à 88 $ jusqu'à l'ouverture du 20/7, 2e déclencheur non coté), offensive Rezaei non matérialisée au 19/7, médiation Chine-Pakistan active, gazole France 2,10 €/L sans pénurie + recalibrage A 3-8 / B 22-30 / C 62-70 (C modal nettement renforcé, médiane ~66)
│   ├── synthese_J138-J141.md              # Synthèse périodique précédente (archivée) — le corridor fantôme : transits réduits à 8 navires/j empruntant majoritairement la route iranienne (corridor escorté non matérialisé), prime Dated Brent physique réapparue, GL X1 expirée le 17/7 (ré-exposition sanctions secondaires Chine/Inde), 2e marin civil tué (VLCC Mombasa B), 7-8 nuits de frappes CENTCOM élargies jusqu'à Yazd (appui logistique israélien rendu public), ultimatum Rezaei (fenêtre ~19-21/7), premiers blessés militaires US sous feu iranien (aucun mort) — Brent 88,10 $ (+13-16 % hebdo) sans rupture pricée >90 $, médiation Chine-Pakistan conjointe, gazole France 2,05-2,07 €/L sans pénurie (~4 % stations) + recalibrage A 4-10 / B 27-36 / C 52-60 (C modal renforcé)
│   ├── synthese_J135-J138.md              # Synthèse périodique précédente (archivée) — le marché cote la guerre : Brent 83,30 $ (+9,6 %) puis >85 $ avec backwardation 8,92 $, blocus naval US réimposé (14 juillet), 3 pétroliers frappés en un jour (JMIC « SEVERE »), marin du GFS Galaxy confirmé mort, MOU dénoncé déclarativement par Téhéran, gazole France >2 €/L — mais flux escorté réel (8-8,5 Mb le 12/7, DOE) et médiation active + recalibrage A 5-12 / B 28-38 / C 45-55 (C modal renforcé)
│   ├── synthese_J131-J135.md              # Synthèse périodique antérieure (archivée) — le seuil létal franchi : premières morts rapportées (14 selon le min. iranien de la Santé, borne basse), 3 salves CENTCOM (>300 cibles), GFS Galaxy frappé (1 marin disparu), Ormuz déclaré « fermé jusqu'à nouvel ordre » avec transits effondrés — mais prix non encore coté (Brent 76,01 $, fermeture du 12 non pricée) et canal diplomatique actif + recalibrage A 8-15 / B 30-40 / C 40-50 (C modal)
│   ├── synthese_J119-J131.md              # Synthèse périodique antérieure (archivée) — la rechute violente : reprise des frappes directes US↔Iran (7-8 juillet), 3 navires frappés par le CGRI, licence pétrolière US révoquée, Trump déclare le cessez-le-feu « terminé » — mais sans mort rapportée ni nullité juridique du MOU + Brent en rebond modéré (~74-78 $) + recalibrage A 15-25 / B 33-43 / C 32-42
│   ├── synthese_J111-J119.md              # Synthèse périodique antérieure (archivée) — accord signé qui s'applique (blocus US levé, aval conditionnel du Guide) puis se fissure (Ormuz re-fermé par le CGRI, frappe Ever Lovely, OMI suspend l'évacuation, litiges avoirs/AIEA) + Brent au plus bas en 4 mois + recalibrage A 40-50 / B 35-45 / C 12-18
...
- **Header & footer mutualisés** : générés par les Web Components natifs `<site-nav active="…">` et `<site-footer [variant="…"]>` définis dans `app/nav.js` (**source unique**, plus aucune duplication entre pages). Chaque page n'écrit que la balise + l'attribut `active` ; `nav.js` rend la barre `topbar` (marque + compteur J-day + liens), pose la classe `active` et le pied de page. Sous 700 px, les liens se replient dans un **menu hamburger** (bouton ☰, panneau en surimpression — rendu et géré par `nav.js`, styles dans `styles_common.css`) ; au-dessus, `display: contents` sur `.nav-links` restitue le rendu desktop inchangé. La barre est `position: sticky` portée par `<site-nav>` (cf. `styles_common.css`), pas par `.topbar`. Toute modification de l'ordre/des liens de nav ou du texte de footer se fait **uniquement dans `nav.js`**.
