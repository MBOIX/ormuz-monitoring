...
### Édition 2.7 — 3 juin 2026 (J95) — Iran SUSPEND les pourparlers (1er juin), Exxon alerte Brent physique 150-160 $, douleur sur l'aval du baril (raffinés 2-3× le brut), urée >850 $/t, remise carburant expire fin juin
...
| Paramètre | Valeur |
|---|---|
| **Scénario de référence** | B — Réaliste / Enlisement stagflationniste (**probabilité 58-64 % au 3 juin, CENTRAL CONSOLIDÉ**, [scenario_realiste.md](scenario_realiste.md)). A 10-15 % (Iran SUSPEND les pourparlers le 1er juin, WH dénie le brouillon MOU iranien) ; C 24-32 % (re-armement du risque escalade : suspension Iran + menace Bab el-Mandeb, récession technique DE/IT actée BCE/Commission UE, défaillances FR record 35 ans) |
...
| **Date d'édition** | **3 juin 2026 (J95 du conflit Ormuz) — Édition 2.7** |
...
**⭐ Lecture rapide au 3 juin (J95) — Édition 2.7 (vue 3 mois, B central consolidé, risque C re-armé, douleur sur l'aval du baril ; remise 20 c/L expire fin juin)** :

- **🚨 PRIORITÉ FIN JUIN — gazole + fioul AVANT l'expiration de la remise 20 c/L (fin juin)** : profiter du repli temporaire du Brent (gazole détail ~1,95-2,15 €/L) AVANT le risque de marche d'escalier de ~+20 c/L au 1er juillet. **Si chauffage fioul, planifier remplissage avant fin juin** (économie 500-1 200 € + remise). Le reflux du Brent (-15,3 % sur 1 mois) ne se transmet PAS à la pompe (raffinés 2-3× plus vite que le brut, Fortune/JPMorgan).
...
- **Date butoir** : **AVANT FIN JUIN 2026 (S26) — la remise carburant de 20 c/L EXPIRE FIN JUIN** : risque de marche d'escalier de ~+20 c/L au 1er juillet à périmètre Brent inchangé. Acheter avant cette date capture la remise ET évite le palier 🟠 généralisé. Attention : le reflux du Brent (-15,3 % sur 1 mois) ne se transmet PAS proportionnellement à la pompe — les raffinés montent 2-3× plus vite que le brut (Fortune 31 mai / JPMorgan), et Exxon (28 mai) projette des cargaisons physiques Brent à 150-160 $/b sous 2-3 semaines. Après l'été : probabilité forte d'allocations station et de pic prix > 2,40 €/l.
...
- **Stocks France** : stockages souterrains (Storengy, Teréga) capacité totale ~138 TWh, **niveau cohérent avec le stockage gaz UE à 38 % au 2 juin** (cible 90 % au 1er nov.) — **inquiétude hiver confirmée** : injection forcée à prix forts (TTF 47,69 €/MWh, +32,2 % YoY), Hormuz coupant ~1/5 du GNL mondial et QatarEnergy en force majeure sur 17 % de sa liquéfaction (Ras Laffan).
...
- **Sensibilité déclencheurs** : `+++` (cascade indirecte via gaz TTF + arrêts NH₃ UE + arrêt urée Chine 50-75 % + escalade Ormuz). **Urée >850 $/t (+80 %) au 3 juin + tender Inde 2,5 Mt à 950 $/t + QatarEnergy/QAFCO toujours en force majeure** = pression haussière confirmée. Projection BGL (Allemagne, IRU) : **+170 % possible** sur le prix AdBlue. Italie : **+20-25 % retail** déjà observé. **Effet 2022 répété mais plus structurel** (Ormuz = chaîne urée globale, pas seulement gaz UE).
...
- **Vendredi 6 juin 2026 (J98)** — suite de la suspension iranienne des pourparlers (1er juin) + tenue/rupture du cessez-le-feu Liban (poussée Israël au-delà du Litani) + bulletin UFIP hebdo + niveau SPR US hebdo
- **Mi-juin 2026 (J~105)** — point Exxon « cargaisons physiques 150-160 $/b sous 2-3 semaines » (échéance critique) + niveau stockage gaz UE vs trajectoire 90 % + bulletin AdBlue/urée
