...
## Trajectoire centrale : Scénario C (Escalade / guerre d'usure — modal, 64-72 % à J144) — Période S29 → S40 (13 juillet → 4 octobre 2026)
### Édition 3.0 — 13 juillet 2026 (J136), recalée au 15 juillet 2026 (J138) — refonte complète : nouvelle fenêtre de 12 semaines, ré-ancrage sur C modal, re-cotation des 42 produits avec relecture adversariale (29 ajustements), correction d'erreurs de mécanisme héritées (soja Brésil, ananas, poisson importé : flux Atlantique / mer Rouge, PAS Ormuz). **⚠️ Correctif J138 (vérification adversariale)** : le « Brent 79,02 $ au 13 juillet » de l'édition initiale était erroné — **clôture réelle 83,30 $ (+9,59 %, plus forte séance depuis mai 2020), puis 84,73 $ le 14 et >85 $ en séance le 15 : le seuil de choc 85-90 $ est atteint en borne basse**, et le gazole français a refranchi 2 €/L (2,003 €/L le 15/7). Constat central maintenu à J138 : **aucune pénurie nouvelle constatée en France** (5 % des stations en difficulté — tension logistique, pas de rupture) — le risque de la fenêtre est un **choc de prix désormais enclenché et un automne cumulatif** (distillats mondiaux, hiver gazier, rentrée), pas une rupture immédiate

> **🔄 Recalage J144 (21 juillet 2026).** Probabilités scénarios révisées : **C 64-72 % (modal, médiane ~68) · B 20-28 % · A 3-8 %** (cf. [`synthese_J142-J144.md`](synthese_J142-J144.md), qui fait foi sur l'état courant). **Trajectoire centrale toujours C modal ; le calendrier S29→S40 ci-dessous reste inchangé, mais deux paramètres d'entrée se dégradent nettement** : (1) **le flux physique s'effondre** — **7 transits/jour** en moyenne sur la semaine close le 19/7 (contre 16/j) puis **aucun navire observé le 21/7**, soit **−66 % hebdo** selon Lloyd's List (réserve : AIS coupé ⇒ borne inférieure) ; (2) **le JMIC passe de « SEVERE » à « CRITICAL »** (Warning 094/26). Le **2ᵉ déclencheur de « C franc » reste NON TRANCHÉ** : le Brent a franchi 90 $ à quatre reprises (haut **91,49 $** le 21/7) **sans jamais clôturer au-dessus** (settle du 20/7 : 89,22 $) et sans approcher 100 $. Deux contre-poids retiennent le déplacement des paliers : l'**ultimatum Rezaei a expiré sans offensive de grande échelle** (reclassé de lacune en fait négatif documenté) et une **trêve de 10 jours portée par quatre médiateurs (Qatar, Égypte, Oman, Pakistan)** est sur la table, non acceptée. **Nouveau facteur à surveiller pour les paliers gaziers et le fret** : les **Houthis ont déclaré un blocus naval de l'Arabie saoudite** (20/7) — **déclaré, non exécuté** —, exposant **2,5 à 4,5 Mb/j** supplémentaires. Une bascule des paliers dépendrait de clôtures répétées du Brent >90 $, de la réapparition d'une forte prime Dated Brent (non chiffrée depuis le 16/7) ou de l'exécution effective du blocus houthi.

> **🔄 Recalage J141 (18 juillet 2026).** Probabilités scénarios révisées : **C 52-60 % (modal renforcé, médiane ~56) · B 27-36 % · A 4-10 %** (cf. [`synthese_J138-J141.md`](synthese_J138-J141.md), qui fait foi sur l'état courant). **La trajectoire centrale reste C modal et le calendrier S29→S40 ci-dessous est inchangé** : la fenêtre 16-18/7 (échec du corridor escorté, prime Dated Brent physique réapparue, GL X1 expirée, 2ᵉ marin civil tué, crack diesel ~66 $) confirme la trajectoire sans en déplacer les paliers. Les figures de probabilité du corps ci-dessous ont été alignées sur ce recalage ; les faits marché datés (Brent 83,30 $, gazole 2,003 €/L) restent ceux du 13-15/7.

---

## 1. Métadonnées et avertissements

| Paramètre | Valeur |
|---|---|
| **Scénario de référence** | **C — Escalade / guerre d'usure (modal renforcé : 52-60 % au 18 juillet 2026, J141**, [scenario_pessimiste.md](scenario_pessimiste.md)) ; bornes : B — Enlisement / corridor militarisé stabilisé 27-36 % ([scenario_realiste.md](scenario_realiste.md)), A — Accord durable 4-10 % ([scenario_optimiste.md](scenario_optimiste.md)). **NB : « C modal » = guerre d'usure durable avec Ormuz fermé/dangereux et prix qui cotent (c'est désormais le cas : Brent >85 $) — PAS la guerre totale ni un Brent > 150 $. C'est une fourchette (52-60 %), pas une certitude : la lecture B (Annexe C) reste plausible.** En cas de re-capage confirmé (corridor omanais accepté, session de Doha tenue, transits AIS durablement > 40/j), basculer sur la lecture B de l'Annexe C. |
...
| **Date d'édition** | **13 juillet 2026 (J136 du conflit Ormuz) — Édition 3.0** ; **probabilités recalées le 18 juillet 2026 (J141)** via [synthese_J138-J141.md](synthese_J138-J141.md) (C 52-60 / B 27-36 / A 4-10) ; Brent et gazole recalés le 15 juillet 2026 (J138) via [synthese_J135-J138.md](synthese_J135-J138.md) |
...
> **Document prévisionnel sous trajectoire centrale C (scénario modal renforcé à J141 : 52-60 %) — une fourchette, pas une certitude.** La borne moins sévère (B — corridor militarisé stabilisé, porté par la médiation Pakistan-Qatar-Oman et le double corridor omanais, 27-36 %) et la borne de détente (A — accord durable, 4-10 %, très improbable) sont traitées en **Annexe C**. Trois mécanismes de la fenêtre sont **indépendants de l'issue Ormuz** et s'appliquent sous B comme sous C : la tension mondiale sur les distillats (exports diesel russes suspendus, crack spread record), le choc climatique café (Brésil) et les tensions médicaments préexistantes (ANSM). Voir [scenario_pessimiste.md](scenario_pessimiste.md) et [scenario_realiste.md](scenario_realiste.md) pour les signaux de bascule.
>
> **🔧 Affinage Édition 3.0 (13 juillet 2026, J136) — REFONTE : NOUVELLE FENÊTRE S29→S40, RÉ-ANCRAGE SUR C MODAL, RE-COTATION ADVERSARIALE DES 42 PRODUITS** : l'Édition 2.9 (15 juin) était ancrée sur « accord confirmé, prix en chute » — l'exact inverse de la situation au 13 juillet (guerre d'usure ouverte, 14 morts selon le ministère iranien de la Santé, *GFS Galaxy* frappé, **Ormuz déclaré « fermé jusqu'à nouvel ordre » le 12 juillet**, transits AIS ~11-17/j puis quasi nuls — cf. [synthese_J131-J135.md](synthese_J131-J135.md) ; depuis le 15 juillet, [synthese_J135-J138.md](synthese_J135-J138.md) fait foi). Méthode : 4 collecteurs par catégorie (recherche web produit par produit) + 4 relecteurs adversariaux → **29 ajustements**. Neuf points structurants :
>
> 1. **Le verdict des marchés du lundi 13 juillet est tombé — et il a été CORRIGÉ à J138** : la clôture réelle est **83,30 $ (+9,59 %, plus forte séance depuis mai 2020)** [FAIT, B2 — vérifié, 4 sources ; le « 79,02 $ » de l'édition initiale, source unique, était erroné], suivie de **84,73 $ le 14 (pic ~87 $) et >85 $ en séance le 15**, avec une **backwardation front/6 mois de 8,92 $**. **Le seuil de 85-90 $ est atteint en borne basse** : le marché price désormais un choc de prix réel — mais pas une rupture d'approvisionnement (ce serait 100 $+ ; le flux escorté mesuré par le DOE, 8-8,5 Mb le 12/7, l'explique).
> 2. **Aucune pénurie nouvelle constatée en France à J136 — confirmé à J138** malgré l'aggravation militaire : mais la transmission prix est désormais **enclenchée** — **gazole 2,003 €/L le 15/7 (relevé AFP, +5,3 % vs la moyenne du 6/7 à 1,903 €/L ; le signal ~1,97-1,98 €/L du 12/7 est confirmé et dépassé), 5 % des stations en difficulté** (tension logistique, pas de rupture), grands départs du 11-14 juillet sans incident, aucune rupture alimentaire, **l'inflation alimentaire décélère** (+0,9 % a/a en juin, 5ᵉ mois consécutif — l'Édition 2.2 anticipait +4-6 %). Le « biais d'optimisme inversé » de l'Édition 2.1 est **re-confirmé massivement** : cas d'école de l'huile de tournesol (classée 🚨 urgence en mai, prix détail stable 7 semaines plus tard, FAO confirmant la stabilité spécifique du tournesol).
...
>
> α. **[FAIT/B2] Brent papier en reflux malgré l'escalade** : ~93,1 $/b en clôture (5 juin), après un pic intraday 3 juin ~99 $ (clôture 97,81 $) puis ~95 $ le 4 juin. WTI ~90,3-90,5 $ ; **spread Brent-WTI comprimé à ~2,5 $/b** (vs ~13 $ le 30 avril). Le marché papier ne tarife PAS un choc d'offre imminent.
> β. **[SPÉCULATION] La thèse Exxon (28 mai) de cargaisons physiques Brent à 150-160 $/b N'EST PAS matérialisée à J98** : aucune assessment Platts/Argus Dated Brent en source ouverte ne l'établit ; dernière donnée physique solide = prime > 25 $/b sur les futures (EIA, avril). **Le Dated Brent physique courant est un *gap* (non publié)** — à ne pas combler par une estimation. La doctrine de précaution sur les produits dérivés reste justifiée par la *tension physique* et l'effet aval, pas par un niveau Dated chiffré.
> γ. **[FAIT/B2] La douleur reste sur l'AVAL du baril** (Fortune/JPMorgan, maintenu) : les raffinés montent plus vite que le brut → le reflux du Brent papier ne se transmet PAS proportionnellement à la pompe.
> δ. **[FAIT/C2] CONTRE-INTUITIF — au détail, c'est l'ESSENCE qui est la plus touchée, pas le diesel** : sur ~2 307 stations en difficulté (dont ~411 critiques, 13 régions), le **gazole est le carburant le MOINS touché (442 stations)** vs SP98 (1 139 stations). Le diesel garde la priorité réglementaire (fret, ORSEC) ; l'essence est la première à manquer en station. → relativise la hiérarchie « gazole d'abord » pour le ménage automobiliste essence.
> ε. **[FAIT/A1] Prix pompe en léger repli hebdo** : gazole **2,047 €/L**, SP95 **2,032 €/L**, SP98 2,074, E10 1,973 (5 juin, Ministère). Gazole professionnel (indice CNR) **+29,3 % vs février** (fin mai), **en REPLI** depuis le pic +42,7 % de début avril (trajectoire décroissante). **Remise carburant 20 c/L expire fin juin** → risque de marche d'escalier maintenu au 1er juillet.
> ζ. **[FAIT/B2] AdBlue/DEF : risque ANTICIPÉ, AUCUNE rupture constatée à J98** — *gap* : pas de donnée de rupture effective en source ouverte. Le signal de marché reste haussier (urée physique livré ~935-959 $/t ≈ ×2 pré-guerre), mais la fiche 5.1.9 décrit une *vigilance prospective*, pas une pénurie observée.
> η. **[FAIT/A1] Gaz UE ~41,5 %** (5-6 juin, corrige le 38 % qui datait du 23 mai) ; cible hivernale assouplie à 80 % ; Pays-Bas < 16 %. Force majeure QatarEnergy/Ras Laffan **prolongée jusqu'à mi-août 2026**. **Inflation FR IPC mai +2,4 % a/a** (IPCH +2,8 %, énergie +16,8 %) ; pas de chiffre de juin avant le 30 juin (*gap*). Banque de France a annoncé le 1er juin une **révision EN BAISSE** de la croissance FR 2026 (était +0,9 % en mars), nouveau chiffre ~mi-juin (*gap* — ne pas pré-remplir) ; PIB T1 -0,1 %.
>
> **Pertes [A1/A2/B2]** : **7e Casque bleu FINUL tué le 4 juin** (sergent serbe Jovanović, près de Marjeyoun ; attribution non établie) — l'« aucun mort depuis le 22 avril » est CADUC. **Militaires français morts au Moyen-Orient = 3 au total, inchangé** : 2 FINUL/Liban (Montorio 18/4, Girardin 22/4) + 1 Chammal/Irak (Frion 12/3). **Aucune nouvelle perte française.** Tués au Liban depuis le 2 mars ≈ 3 433-3 500 (~3 200 civils). **Cessez-le-feu Liban annoncé à Washington le 3 juin REJETÉ par le Hezbollah (Qassem) le 4 juin → accord mort-né** ; Israël poursuit au sud du Litani.
>
> **🔧 Affinage Édition 2.7 (3 juin 2026, J95) — IRAN SUSPEND LES POURPARLERS, DOULEUR SUR L'AVAL DU BARIL, REMISE CARBURANT EXPIRE FIN JUIN** : la fenêtre 28 mai → 3 juin acte un **re-armement du risque C** (A rétrogradé à 10-15 %, C remonté à 24-32 %) et déplace le centre de gravité du choc du brut vers les produits raffinés. Six développements structurants :
>
> a. **Iran SUSPEND les pourparlers le 1er juin** (motif Liban) + vise une **fermeture complète d'Ormuz** + **menace Bab el-Mandeb** → re-armement du scénario C. Trump répond « accord dans la semaine », CNN « back on track » quelques heures plus tard, mais le brouillon MOU (trafic Ormuz libre, mines retirées sous 30 j, levée proportionnelle du blocus, waivers ventes pétrole iranien) reste **non signé** et la WH dénie le brouillon iranien. La doctrine d'achat de précaution est **maintenue** : la suspension neutralise tout scénario A de détente rapide.
> b. **Exxon (28 mai) alerte sur des cargaisons physiques Brent à 150-160 $/b** quand les stocks toucheront leurs **plus-bas absolus « dans 2-3 semaines »** → confirme et renforce la **doctrine de précaution sur les produits dérivés** (gazole, fioul, jet, GPL, naphta, AdBlue) : le prix payé in fine par le consommateur suit le physique, pas le papier.
> c. **La douleur se déplace vers l'AVAL du baril** (Fortune 31 mai + JPMorgan) : les **produits raffinés (gazole/essence/jet/GPL/naphta) montent 2-3× plus vite que le brut** (Asie surtout ; raffineries réduisant leurs débits = « fault lines of the real global energy shock »). → **renforce tous les paliers énergie et transport** : le reflux du Brent (-15,3 % sur 1 mois) ne se transmet PAS proportionnellement à la pompe.
> d. **Urée >850 $/t (+80 % depuis février)**, **tender Inde du 15 avril 2,5 Mt à 950 $/t**, QatarEnergy/QAFCO en **force majeure** → renforce **AdBlue/DEF** et la cascade **engrais → récolte 2026/2027** (qualité protéique en baisse, intrants 2027).
> e. **Stockage gaz UE à 38 % seulement** (cible 90 % au 1er nov) → **tension hivernale gaz/GPL/industries énergivores confirmée** : injection forcée à prix forts, TTF maintenu haut (47,69 €/MWh, +32,2 % YoY).
> f. **La remise carburant de 20 c/L EXPIRE FIN JUIN** → **risque de marche d'escalier sur le prix à la pompe début juillet** : à périmètre Brent inchangé, le gazole et l'essence peuvent gagner mécaniquement ~+20 c/L au 1er juillet. **Argument fort pour acheter gazole/fioul AVANT fin juin** (fiches 5.1.1, 5.1.2, 5.1.4).
>
> **🔧 Affinage Édition 2.2 (17 mai 2026, J78) — RESTITUTION TRAJECTOIRE 3 MOIS** : l'Édition 2.1 avait correctement décalé les bascules court terme S19-S22 (validation web confirmée : propagation pétrole→produits dérivés prend 6-12 semaines), **mais avait à tort atténué les paliers cibles tardifs S25-S30**. **Sous scénario B sustained 3 mois (60-68 % de probabilité)**, l'enlisement amplifie progressivement les tensions par 5 mécanismes cumulés :
>
> 1. **Inflation alimentaire retardée** : choc Brent 109 $ commence seulement à se diffuser (IPC alimentaire avril = +1,2 % a/a en ralentissement). Historiquement, post-choc pétrolier, inflation alimentaire +2-4 %/mois pendant 3-6 mois (cf. 1979 +13 %/an, 2022 +5,2 %). **Pic attendu juillet-août 2026 : +4-6 % a/a**.
> 2. **Récolte 2026 compromise** : engrais urée +30 % depuis février (Qatar Qafco = 14 % commerce mondial), récolte FR juin-juillet aura **qualité protéique en baisse** (Arvalis). **Effet alimentaire mi-juillet** sur pain, semoule, biscuiterie. **Récolte mer Noire (tournesol) juillet-août également compromise**.
> 3. **Stocks SAGESS pétroliers et API médicaments fondants** : SPR US -8,6 mb hebdo (record), épuisement marges mi-juin. **API Inde/Chine via océan Indien** : retard +4-8 semaines + +1500-4000 $/conteneur = **tensions médicaments génériques dès mi-juin**.
> 4. **Stockage gaz UE 34,3 % vs cible 90 % au 1er nov** : injection forcée à prix forts = TTF maintenu haut → **industries énergivores (verre, papier, chimie, ciment) en chômage partiel dès juillet** → effet cascade emballages, hygiène, produits transformés.
> 5. **Ruée comportementale + saison froide automnale anticipée** : tout patient chronique ou ménage informé anticipera dès juillet-août les approvisionnements hiver (paracétamol, sartans, antibiotiques, fioul, pétrole lampant, eau).
>
> **Édition 2.2 = Édition 2.1 + restitution des paliers cibles tardifs** :
>
> | Produit | Édition 2.1 (2.0 corrigée) | Édition 2.2 (3 mois B) | Justification |
> |---|---|---|---|
> | Huile tournesol | 🟡 → 🟠 S25 → 🟠 S30 | 🟡 → 🟠 S24 → **🔴 S29-S30** | Récolte mer Noire juillet-août 2026 compromise (engrais +30 %) |
> | Riz basmati | 🟡 → 🟠 S27 → 🟠 S30 | 🟡 → 🟠 S26 → **🔴 S29-S30** | Océan Indien sous pression sustained 3 mois |
> | Paracétamol pédia | 🟡 → 🟠 S30 | 🟡 → **🟠 S27 → 🔴 S29-S30** | Saison froide approche + API Asie sustained |
> | Sartans | 🟡 → 🟠 S26 → 🟠 S30 | 🟡 → 🟠 S26 → **🔴 S29-S30** | Pic 6 sem. post-Brent + ruée comportementale |
> | Power banks | 🟢 → 🟡 S30 | 🟢 → 🟡 S26 → **🟠 S28-S30** | Suspension Chine batteries (nov 2025-nov 2026) + cumul lithium |
> | Eau embouteillée | 🟡 toute période | 🟡 → **🟠 S27-S30** | Canicule + PET cher + ruée comportementale estivale |
> | Pâtes sèches | 🟢 toute période | 🟢 → **🟢→🟡 S28** | Transport pâtes italiennes répercute Brent |
> | Conserves | 🟢→🟡 S23 | 🟢→🟡 S23 → **🟠 S28-S30** | Cumul inflation + emballage acier/aluminium énergivore |
> | Œufs | 🟢→🟡 S23 (rétrogradé 2.1) | 🟢→🟡 S23 → **🟠 S27-S30** | Alimentation animale (soja) cumul + énergie poulaillers |
> | Légumineuses sèches | 🟡 → 🟠 S29 | 🟡 → **🟠 S27 → 🟠/🔴 S30** | Cumul fret Canada/Australie + cumul inflation |
> | Beurre/fromages | 🟡 maintenu | 🟡 → **🟠 S27-S30** | +25-30 % en 2 ans (Reussir) + cumul énergie chaîne du froid |
> | Viande porcine/volaille | 🟡 maintenu | 🟡 → **🟠 S27-S30** | Cumul alimentation animale + énergie élevage |
> | Levothyrox | 🟢 toute période | 🟢 princeps Merck UE → **🟡 S28-S30 génériques (Thyrofix)** | API Inde/Chine sustained 3 mois |
>
> **Confirmés fermement (déjà au bon niveau)** : gazole B7 (🟠 S23, 🔴 fin juillet), viande bovine (🟠 S24-S26), café (🟠 S25-S30), fioul (🟠 S27), fruits exotiques (🟠 S23-S30, 🔴 fin), pétrole lampant (🔴 S25-S30), bovine, poisson frais (🔴 S28-S30).
>
> **Confirmés rétrogradés court terme (validation 2.1 maintenue)** : pas d'urgence S19-S22 sur huile tournesol, riz basmati, paracétamol pédiatrique, power banks, sartans, Levothyrox.
>
> **🔧 Corrections antérieures Édition 2.1 (rappel)** :
>
> | Produit | Édition 2 | Édition 2.1 corrigée | Source |
> |---|---|---|---|
> | Huile tournesol | 🟠 dès S21 | 🟡 S21 → 🟠 S25-S26 | Marché mer Noire détendu 2026 ; risque indirect fret/inflation |
> | Riz basmati | 🟠 dès S22 | 🟡 S22 → 🟠 S27 | Coface : prix mondiaux au plus bas depuis 2017 |
> | Paracétamol pédiatrique | 🟠/🔴 dès S26 | 🟡 S26 (🟠 si pic automne) | ANSM 23 fév : rappel Doliprane résolu, stocks suffisants |
> | Power banks | 🟠/🔴 dès S26 | 🟢 S26 → 🟡 S30 | Marché normalisé (Clubic, Anker mai 2026) |
> | Œufs | 🟠 dès S23 | 🟡 S23 maintenu | +375 M œufs annoncés 2026, sortie tension juin |
> | Eau embouteillée | 🟠 dès S27 | 🟡 S27 | Marché stable 2,67 Md€, impact transport seulement |
> | Pâtes sèches | 🟢→🟡 dès S27 | 🟢 maintenu jusqu'à S30 | Récolte UE +15 % YoY, blé dur en baisse |
> | Sartans | 🟠 dès S23 | 🟡 S23 (🟠 si pic) | Tensions structurelles confirmées mais pas de pic 2026 |
> | **Levothyrox (NOUVEAU)** | — | 🟢 surveillance (avis ANSM J+30) | Production Merck Darmstadt UE, pas de tension signalée |
>
> **Confirmés fermement (pas de changement)** : gazole B7 (🟠 S23, 🔴 fin juillet), viande bovine (🟠 S24-S26, +20-34 % YoY confirmé FranceAgriMer), café (🟠 S25), fioul (🟠 S27), fruits exotiques (🟠 S25, voire avancer S23).
>
> **Synthèse fenêtre 28 mai → 3 juin observée — RE-ARMEMENT DU RISQUE C, DOULEUR SUR L'AVAL J95** :
> - **Iran SUSPEND les pourparlers le 1er juin** (motif Liban) + vise fermeture complète Ormuz + menace Bab el-Mandeb → A rétrogradé à 10-15 %, C remonté à 24-32 %. Trump : accord « dans la semaine » ; CNN : « back on track » quelques heures après. Brouillon MOU (trafic Ormuz libre, mines retirées sous 30 j, levée proportionnelle blocus, waivers ventes pétrole iranien) **toujours non signé** ; WH dénie le brouillon iranien.
> - **Brent 96,89 $ (3 juin, +0,93 %, 3e séance up vers 98 $)** ; **-15,3 % sur 1 mois** (pic 112,93 $ 19 mai) mais **+49,4 % YoY**, ~+70 % vs pré-crise. WTI ~93-94 $. **MAIS** Dated Brent garde sa prime et **EXXON (28 mai) projette des cargaisons physiques Brent à 150-160 $/b sous 2-3 semaines** quand les stocks toucheront leurs plus-bas absolus.
> - **Douleur sur l'AVAL du baril (Fortune 31 mai + JPMorgan)** : raffinés (gazole/essence/jet/GPL/naphta) montent **2-3× plus vite que le brut** (Asie surtout, raffineries réduisant leurs débits). Le reflux du Brent ne protège PAS la pompe.
> - **SPR US à 365,1 mb** (sem. 22 mai, **-9,1 mb** vs 374,2 ; programme 172 mb) — épuisement des marges confirmé. IEA : >1 Md bbl perdus ; release coordonnée record 400 Mb (actée mars).
> - **TTF gaz 47,69 €/MWh (2 juin, +32,2 % YoY)** ; **stockage gaz UE à 38 % seulement** (cible 90 % 1er nov) ; QatarEnergy en force majeure sur 17 % de sa liquéfaction (Ras Laffan, réparation 3-5 ans) → tension hivernale gaz/GPL confirmée.
> - **OPEP+ : EAU ONT QUITTÉ L'OPEP (3 mai)** → moins d'amortisseurs ; hausse juin +188 000 b/j seulement ; quota Arabie 10,291 mb/j vs prod réelle 7,76 mb/j ; réserve mondiale >4 mb/j.
> - **Urée >850 $/t (+80 % depuis février)**, tender Inde 2,5 Mt à 950 $/t → renforce AdBlue + cascade engrais récolte 2026/2027. Méthanol quasi-doublé Asie, >doublé Europe depuis janvier ; aluminium en hausse (fonderies Golfe).
> - **INSEE IPC mai +2,4 % YoY** (vs 2,2 % avril ; accélération énergie/gaz). Gazole : inflation +42,1 % en avril ; gazole pro +31,3 % depuis fin février ; détail ~1,95-2,15 €/L. **Remise carburant de 20 c/L EXPIRE FIN JUIN** → risque de marche d'escalier prix pompe début juillet. OAT-Bund ~67-70 bps. Aides Lecornu 1,2 Md€ maintenues ; mobilisation FNSEA-JA suspendue.
> - **Liban : cessez-le-feu Israël-Hezbollah le 1er juin** (Israël épargne Dahiyeh, Hezbollah n'attaque pas) MAIS Israël pousse au-delà du Litani. **3 militaires FR FINUL tués (inchangé)**.
>
> **Synthèse fenêtre 28 mai observée — RECALIBRAGE LUCIDE J89** :
> - **MOU Doha NON SIGNÉ** : Trump 23/05 « largely negotiated » → WH 27/05 dénie brouillon iranien (« complete fabrication ») → Rubio 26/05 « a few more days ». Iran TV (27/05) : reopening Hormuz **≥ 30 jours APRÈS signature** = retour normalité au mieux fin juillet/août.
> - **INSEE confiance ménages mai 2026 (publié 28/05)** : **82 (-2) = plus bas depuis mars 2023** ; consensus Reuters 83 raté. INSEE acte : « ménages craignent dégradation finances + reportent achats importants à cause du choc pétrolier ».
> - **Brent 28/05 : 96,30 $ (+2,13 %)** — toujours **+70 % vs pré-conflit** (~57 $ fin 2025).
> - **Voix Tier 1 acte la sévérité** : Commission UE révise UE 2026 à **1,1 %** (vs 1,5 % en 2025) ; BCE warn récession technique DE/IT fin 2026 ; inflation zone euro **3 %** avril (plus haut depuis sept 2022) ; IMF worst case = quasi-récession globale 2 % ; BdF scénario adverse 0,3-0,6 % FR.
> - **Défaillances FR (BdF fév 2026)** : **69 392 sur 12 mois = RECORD 35 ANS** ; transport-entreposage **+8,8 %**.
> - **FNTR (mai 2026)** : « choc de coûts sans précédent », « crise brutale et inédite ». Gazole pro **+40 % depuis février**. Marges nettes TPE/PME 2-3 %.
> - **Implication pour le calendrier** : la trajectoire B sustained 3+ mois est désormais le **central institutionnellement reconnu** ; les dommages structurels (récoltes 2027, capacités industrielles, faillites cascade) **s'accumulent même si MOU signé**. La doctrine d'achat de précaution doit être **maintenue voire renforcée** sur produits sensibles tardifs S25-S30, indépendamment du dénouement Doha.
>
> **Synthèse fenêtre 23-27 mai observée — basculement narratif vers A (rappel, partiellement démenti J89)** :
> - **Trump 23/05** : « accord avec l'Iran largely negotiated » + Hormuz à rouvrir → premier signal A opérationnel depuis le début de la crise
> - **Délégation iranienne de haut rang à Doha 25-27/05** : Araghchi (MAE) + Ghalibaf (Speaker) + Hemmati (Gouverneur BCI) — MOU 14 points en finalisation
> - **Périmètre MOU** : moratoire enrichissement (temporaire) + sanctions relief + reopening progressif Hormuz + libération 24 Md$ fonds gelés (12+12 sur 60j) + management iranien du détroit
> - **Sticking points** : décret Mojtaba HEU (21/05) interdit l'export d'uranium ; Trump aurait promis à Israël que HEU sortirait ; risque sabotage Israël / faction faucon GOP
> - **Frappes CENTCOM 25/05** : 2 boats IRGC (mines) + SAM Bandar Abbas — fin du silence opérationnel maritime de 11 jours ; ZÉRO mort US ; talks Doha non rompues
> - **Riposte IRGC 26/05** : revendique MQ-9 abattu + fire F-35 + RQ-4 (non confirmé US) ; warning verbal mais pas d'escalade aérienne
> - **Brent passe SOUS 100 $** : 99,18 $/b le 27/05 (1ère fois depuis fin mars) ; -13,75 $ depuis pic 19/05 (-12,2 %)
> - **TTF gaz rebondit +5,37 %** à 48,04 €/MWh le 26/05 sur frappes US et incertitude deal
> - **FNSEA-JA SUSPEND mobilisation 26/05** après rejet motion loi Duplomb à l'Assemblée → **convergence Gilets Jaunes-FNSEA neutralisée**
> - **Manif GJ 23/05 Place du Louvre** : tenue sans bilan massif identifié ; nouvelle manif programmée 27/05
> - **Aide grands rouleurs 100 €/véh** : plateforme impots.gouv.fr ouverte aux demandes 27/05 (~3M bénéficiaires)
> - **Aucune nouvelle perte française au Liban** (35 jours depuis Girardin 22/04) ; volet sécurité Pentagone 29/05 maintenu
>
> **Implication pour le calendrier** : si MOU Doha signé sous 7-14 jours, **toutes les bascules tardives S25-S30 peuvent être atténuées d'un cran** (🟠 → 🟡, 🟡 → 🟢) dans le 3-mois après la signature. Si Doha échoue, retour à la trajectoire B sustained.
>
> **Synthèse fenêtre 18-22 mai observée** (rappel) :
> - **Carburants France** : gazole en plateau à 2,12 €/L au 16 mai (essence SP95-E10 à 1,97 €/L) ; rebond limité attendu d'ici 7-10 jours après pic Brent 19 mai (112,93 $) puis stabilisation post-reflux 22 mai (104,52 $) ; ruptures stations stables → **palier 🟡 confirmé pour S20-S21**
> - **Brent volatil mais en reflux hebdo** : pic 19 mai 112,93 $ → clôture 22 mai 104,52 $ (-4 % hebdo) sur signes encourageants Rubio + Naqvi V2 → validation indirecte de la trajectoire B (les marchés tarifent le statu quo)
> - **8 jours consécutifs de silence opérationnel maritime** (15-22 mai depuis Hui Chuan 14 mai) → pas d'accélération vers bascule C, **plus longue séquence sans incident létal depuis le début de la crise**
> - **Spread OAT-Bund stabilisé à 69 bps** (22 mai, sous moyenne 1Y 71,8) → soulagement confirmé, **pathway fiscal-social du scénario C amorti** mais reste armé ; dégradation Moody's reportée
> - **TTF gaz à 47,69 €/MWh** (-3,48 % le 22 mai) — Norvège +40 % exports apaise ; UGS projeté 96 % au 1er nov (révision positive vs alerte précoce du 8 mai)
> - **SPR US à 374,2 mb (-9,9 mb hebdo, NOUVEAU RECORD ABSOLU)** — plus bas depuis juillet 2024 ; trajectoire d'épuisement non tenable au-delà de 5-7 semaines (alerte critique fin juin)
> - **Décret Mojtaba Khamenei 21 mai** : interdit l'export d'uranium enrichi hors d'Iran → verrouillage frontal demande US « remove HEU », neutralise offre Poutine 9 mai ; **rétorsion US à surveiller** (sanctions élargies, pause unilatérale blocus, ou frappe ciblée)
> - **Naqvi V2 à Téhéran ~20 mai** (avec Vahidi/CGRI) → 2ème visite en 7 jours, intensité diplomatique inédite ; canal pakistanais ultra-actif
> - **Shift doctrinal Lecornu 21 mai** : 1,2 Md€ d'aides ciblées renforcées (+700 M€ neufs), doublement aide grands rouleurs (50 → 100 €/véh), doublement plafond prime employeur (300 → 600 €/an), prolongation jusqu'à fin août → **amortit le pathway fiscal-social et la convergence Gilets Jaunes-FNSEA fin mai**
> - **INSEE 22 mai** : climat des affaires synthétique 93,6 (-0,5), **emploi 91,7 (-3, plus bas depuis Covid)**, services 93 (-1, plus bas depuis mars 2015 hors Covid), industrie 102,3 (+1,9) — signal récessif graduel sans rupture
> - **Cessez-le-feu Liban +45j** tient formellement (jusqu'à ~29 juin) malgré frappes IDF persistantes (30+ sites Hezbollah le 18 mai)
> - **Aucune nouvelle perte française** (cumul stable depuis 22 avril : 3 soldats FINUL tués)
>
> **Lecture méthodologique** : l'inflation alimentaire France avril 2026 = +1,2 % a/a en ralentissement (INSEE) ; le choc Brent commence seulement à se diffuser. Les produits MITM (sartans, paracétamol pédiatrique, amoxi-clav) ne montrent **pas** de pic spécifique 2026 dans les communiqués ANSM — seuls **psychotropes** sont en alerte aiguë (14 molécules depuis janvier 2025, situation aggravée selon ANSM 8 jan + 5 fév 2026). À noter pour exhaustivité.
>
> **Trois zones d'incertitude majeures**, à pondérer dans toute décision d'achat :
> 1. **Niveau réel des stocks France au déclenchement** (28 février 2026) non public — marge ±2-3 semaines sur les bascules de paliers, surtout pour médicaments MITM (4 mois réglementaires) et SAGESS (90 j stratégiques).
> 2. **Risque comportemental (ruée panique)** : Désamorcé à court terme — Gilets Jaunes 23/05 sans bilan massif, FNSEA-JA suspendue 26/05. Surveiller : **manif GJ 27/05 Louvre 14h**, **INSEE climat ménages 28/05**, **INSEE IPC mai 29/05**.
> 3. **Bascule scénario C (escalade)** : probabilité **18-26 % au 27 mai** (-2 pts vs J83). FNSEA suspendue compense la rupture du silence maritime (frappes CENTCOM 25/05 sans mort US). **En cas de bascule C** (échec MOU + escalade maritime), avancer toutes les dates butoirs de 4 semaines et monter tous les paliers d'un cran.
> 4. **Bascule scénario A (accord)** : probabilité **14-22 % au 27 mai** (+6-10 pts vs J83). Si MOU Doha signé sous 7-14 jours : **gazole vers 1,85-2,00 €/L juillet-août**, **ruptures essence résorbées 4-6 sem**, Brent vers 85-95 $ juin → tous les paliers tardifs S25-S30 peuvent être atténués d'un cran.

---

## 2. Légende des 4 paliers

| Palier | Code | Critères opérationnels |
|---|---|---|
| 🟢 | **Disponible normal** | Prix < +10 % vs pré-crise ; disponibilité > 90 % ; pas de queue ; pas de rationnement |
| 🟡 | **Hausse de prix significative** | Prix +10 à +30 % ; disponibilité 70-90 % ; queues occasionnelles ; pas de rationnement officiel |
| 🟠 | **Pénurie intermittente / rationnement** | Prix +30 à +80 % **OU** rationnement informel (quotas enseigne) ou officiel ; disponibilité 30-70 % ; rayons vides ponctuels |
...
**⭐ Lecture rapide au 13 juillet (J136), recalée au 18 juillet (J141) — Édition 3.0 (fenêtre 12 semaines, C modal 52-60 %, verdict marchés corrigé : Brent +9,6 % puis >85 $, gazole >2 €/L — le choc de prix est enclenché)** :
...
> Lecture : chaque cellule indique le palier dominant attendu en fin de semaine considérée, **sous trajectoire centrale C (modal renforcé, 52-60 % à J141)**. `→` indique une bascule probable au cours de la semaine. `*` = risque **localisé/intermittent ou tarifaire** (le seuil 🔴 « disponibilité < 30 %, rupture > 2 semaines » n'est PAS attendu à l'échelle nationale — annotation issue de la relecture adversariale).
...
## Annexe A — Méthodologie de datation

Chaque date prévisionnelle de bascule est obtenue par **croisement de 5 facteurs**, pondérés selon la spécificité du produit :

1. **Profondeur de stock France** — Sources : SAGESS pour pétrole (90 j stratégiques), MITM ANSM pour médicaments (4 mois pour 422 molécules d'intérêt thérapeutique majeur depuis 2021), FranceAgriMer pour céréales (bilans mensuels), GRTgaz/Teréga pour gaz (138 TWh capacité totale, ~35-45 % au 8 mai), RTE pour électricité (bilan prévisionnel saisonnier), stocks privés industriels quand publiés.
2. **Part d'import affectée par Ormuz** — distinction systématique entre :
   - **Direct** : flux physiques transitant par le détroit (LNG Qatar ≈ 20 % LNG France, brut Golfe ≈ 5-8 %, pétrochimie/intrants Inde-Chine via Suez+Ormuz).
   - **Indirect** : effets de second tour (rebond demande européenne sur sourcing alternatif, coût fret conteneur +200-400 % en avril puis -19/-26 % en mai, énergie raffinerie/usine).
3. **Substituts mobilisables** — stocks SPR US (libération AIE coordonnée), raffineries européennes hors France (Anvers, Rotterdam, Lavera), pays exportateurs alternatifs (Norvège, Algérie, Brésil), substitution variétale (E85 ↔ SP, sartans ↔ IEC), substitution comportementale (eau du robinet ↔ embouteillée).
...
## Annexe B — Sources spécifiques utilisées (au-delà de sources.md)

Sources mobilisées pour ce document **en complément** du tableau central [sources.md](sources.md). Toutes ont été consultées entre J70 et J73.

### Énergie

- **UFIP Énergies & Mobilités** — https://www.ufip.fr (statistiques pétrolières, communiqués filière)
- **SAGESS** (Société Anonyme de Gestion de Stocks de Sécurité) — https://www.sagess.fr (90 j stratégiques pétrole, libérations)
- **DGEC bulletin pétrolier hebdo** — https://www.ecologie.gouv.fr/donnees-et-analyses-statistiques-petrolieres
- **prix-carburants.gouv.fr** (open data) — https://www.prix-carburants.gouv.fr
- **L'Argus carburants** — https://www.largus.fr
- **FF3C** (Fédération Française des Combustibles, Carburants et Chauffage) — https://www.ff3c.org
- **France Gaz Liquides (FGL, ex-CFBP)** — https://www.francegazliquides.fr
- **GRTgaz** (bilan hebdo stockages) — https://www.grtgaz.com
- **Teréga** — https://www.terega.fr
- **CRE** (Commission de Régulation de l'Énergie) — https://www.cre.fr
- **AGSI EU storage** — https://agsi.gie.eu
- **RTE éCO2mix** — https://www.rte-france.com/eco2mix
- **RTE Bilan Prévisionnel** — https://www.rte-france.com/analyses-tendances-prospectives
...
### Alimentation & intrants

- **FranceAgriMer** — https://www.franceagrimer.fr/filiere-grandes-cultures/Cereales/Eclairer/Etudes-et-Analyses/Chiffres-et-bilans
- **FAO Food Price Index** — https://www.fao.org/worldfoodsituation/foodpricesindex/en/
- **FAO huiles végétales (avril 2026)** — https://www.fao.org/newsroom/detail/fao-food-price-index-up-for-third-consecutive-month-largely-on-rising-vegetable-oil-prices/en
- **Insee — IPC avril 2026** — https://www.insee.fr/fr/statistiques/8985365
- **adcf — inflation alimentaire avril 2026** — https://www.adcf.org/inflation-alimentaire-mondiale-hausse-avril-2026/
- **Ministère Agriculture — chiffres clés IAA 2026** — https://agriculture.gouv.fr/industries-agroalimentaires-les-chiffres-et-indicateurs-cles-2026
- **Que Choisir — inflation alimentaire 2026** — https://www.quechoisir.org/actualite-inflation-pourquoi-les-prix-alimentaires-devraient-repartir-a-la-hausse-n176074/
- **franceinfo — ANIA hausse prix mai 2026** — https://www.franceinfo.fr/economie/commerce/hausse-des-prix-l-industrie-alimentaire-milite-pour-des-augmentations-de-quelques-centimes-sur-certains-produits-de-maniere-ponctuelle_7997006.html
- **Réussir — récolte 2026 prévisions UE** — https://www.terre-net.fr/actualite-des-marches/article/897694/moisson-2026-les-premieres-previsions-de-l-ue-pour-les-cereales
- **La France Agricole — récolte 2026 engrais qualité** — https://www.lafranceagricole.fr/conjoncture-cultures/article/895979/recolte-2026-des-engrais-plus-chers-font-craindre-une-qualite-en-baisse
- **DG Trésor — qui sème la guerre (engrais)** — https://www.tresor.economie.gouv.fr/Articles/2026/03/13/qui-seme-la-guerre-ne-seme-guere-les-engrais
- **Ministère Agriculture — soutien GNR** — https://agriculture.gouv.fr/face-la-persistance-de-prix-eleves-des-carburants-le-gouvernement-renforce-son-soutien-aux
- **Chaîne Logistique Froid — point situation 20 avril 2026** — https://www.lachainelogistiquedufroid.fr/crise-du-carburant-point-de-situation-au-20-avril-2026-pour-le-transport-sous-temperature-dirigee/
- **franceinfo — Boulogne criée gazole marin** — https://www.franceinfo.fr/economie/transports/prix-des-carburants/reportage-a-la-criee-de-boulogne-sur-mer-la-hausse-des-prix-du-gazole-marin-se-repercute-sur-toute-la-filiere-jusqu-au-prix-final-du-poisson_7906712.html
- **info.fr — café doublement prix fin 2026** — https://info.fr/cafe-prix-doublement-france-2026/

### Hygiène / santé / équipement

- **ANSM — Disponibilités médicaments** — https://ansm.sante.fr/disponibilites-des-produits-de-sante/medicaments
- **ANSM — Plan hivernal 2025-2026** — https://ansm.sante.fr/actualites/plan-hivernal-2025-2026-point-sur-lapprovisionnement-en-medicaments
- **ANSM — Stock sécurité MITM 4 mois** — https://ansm.sante.fr/actualites/disponibilite-des-medicaments-les-medicaments-dinteret-therapeutique-majeur-doivent-desormais-disposer-dun-stock-de-securite-de-deux-mois
- **France Assos Santé — 422 MITM stock 4 mois** — https://france-assos-sante.org/actualite/stock-minimal-de-securite-augmente-a-4-mois-pour-422-medicaments-2446-medicaments-a-interet-therapeutique-majeur-en-penuries-en-2021-on-est-encore-loin-du-compte/
- **CNOP** — https://www.ordre.pharmacien.fr/les-communications/focus-sur/les-actualites/stock-minimal-de-securite-augmente-a-4-mois-pour-422-medicaments
- **LEEM — Pénuries de médicaments** — https://www.leem.org/kit-presse/penuries-de-medicaments
- **MEMN alerte PET (eau embouteillée)** — https://eaumineralenaturelle.fr/gouttes-dactu/la-memn-alerte-sur-la-hausse-des-prix-des-matieres-premieres-plastique-pet
- **Caducee — stocks État masques 2026** — https://www.caducee.net/actualite-medicale/16788/stocks-de-masques-et-d-epi-la-france-face-au-mur-de-la-peremption-en-2026.html
- **Le Quotidien du Pharmacien — FFP2 made in France** — https://www.lequotidiendupharmacien.fr/exercice-pro/ffp2-le-dilemme-du-made-france
- **Docshipper — fret France-Chine 2026** — https://docshipper.fr/fret-chine-france-tarifs-temps-transit-droits-taxes-conseils-import-export/
- **Inkubox — conteneur Chine-France mai 2026** — https://inkubox.com/conteneur-chine-france-couts-delais/
- **Trans.info — CMA CGM évite Suez 2026** — https://trans.info/fr/cma-cgm-evite-suez-2026-450367
- **Médtech France — pénurie médicaments janvier 2025** — https://www.medtechfrance.fr/vie-de-la-profession/actualites/penurie-medicaments-crise-conjoncturelle-ou-structurelle-etat-lieux-france-janvier-2025/

### Contexte général crise Ormuz

- **Wikipedia — Crise détroit d'Ormuz 2026** — https://fr.wikipedia.org/wiki/Crise_du_d%C3%A9troit_d%27Ormuz_(2026)
- **Docshipper — crise fret maritime 2026** — https://docshipper.fr/actualites/crise-fret-maritime-2026-impact-du-detroit-dormuz-explosion-des-couts/
- **Ports et Corridors — Ormuz Suez** — https://portsetcorridors.com/2026/ormuz-un-conflit-avec-des-repercussions-jusquau-canal-de-suez/
- **France 24 — pénurie médicaments Afrique** — https://www.france24.com/fr/afrique/20260331-guerre-moyen-orient-penurie-medicaments-afrique-importations-carburant-hausse-cout-blocage

---

## Annexe C — Bornes alternatives (lecture sous B et A)

Ce calendrier est rédigé sous la **trajectoire centrale C (modal renforcé, 52-60 % à J141)**. Les paliers et dates butoirs ci-dessus intègrent déjà la prudence — il n'y a **pas** de « lecture pire » à appliquer par défaut. Pour les bornes moins sévères :

### Sous le scénario B — Enlisement / corridor militarisé stabilisé (27-36 %, nettement derrière C depuis J138)
...
### Sous le scénario A — Accord durable (4-10 %, très improbable)
...
## Annexe D — Journal de mise à jour

| Date | Édition | Auteur | Modifications |
|---|---|---|---|
| **12 mai 2026 (J73)** | **1.0** | OSINT Ormuz | Création initiale du document. Calendrier S19 → S30 sous scénario B. 40 produits couverts (8 énergie + 12 alimentation base + 10 frais + 10 hygiène/santé/équipement). Top 10 actionnable + 4 tableaux matriciels + fiches détaillées + 4 annexes. Recoupement minimum 2 sources Tier 1 par date critique. Niveau de confiance global ★★★★. |
| **17 mai 2026 (J78)** | **2.0** | OSINT Ormuz | Mise à jour fenêtre 14-17 mai. **Probabilité scénario B révisée à 60-68 %** (vs 50-58 % à J73). Validation paliers S20 sur les produits documentés Tier 1 (carburants stables 🟡, ruptures stations inchangées 2,8 % / 22,5 %, gazole en léger repli temporaire 2,12-2,15 €/L mais rebond attendu après Brent 109 $ du 15 mai). **Top 10 actualisé** avec dates relatives à J78. Ajout note observations 14-17 mai dans la section matrices. **Aucune avance de date** : silence opérationnel détroit 15-17 mai, OAT-Bund en repli à 70 bps (-7), ceasefire Liban prolongé +45j → pathway C amorti temporairement (24-32 % vs 28-35 %), pas de justification pour resserrer les échéances. Lecture comparée Annexe C inchangée. |
| **17 mai 2026 (J78)** | **2.1** | OSINT Ormuz | **Affinage post-validation web ciblée** (2 agents de recherche en parallèle : validation Top 10 + produits matriciels critiques ; recherche dédiée Levothyrox). **Diagnostic** : Édition 2.0 surestimait la vitesse de propagation pétrole → produits dérivés (anticipée 2-4 semaines, réelle 6-12 semaines selon FranceAgriMer / NielsenIQ / Coface). **Corrections appliquées** : (a) Top 10 réorganisé — gazole + fioul + viande bovine + fruits exotiques + café confirmés fermement, huile tournesol/riz basmati/paracétamol pédiatrique/power banks rétrogradés en surveillance ; (b) **ajout Levothyrox** en n°11 surveillance (★★★★★ — risque faible, production Merck Darmstadt UE, aucune tension ANSM au 17 mai) ; (c) matrices alimentation : pâtes maintenues 🟢 (récolte UE +15 % YoY), riz basmati / huile tournesol décalés de 3-4 sem., œufs détendus (+375 M annoncés 2026) ; (d) matrices santé : sartans et paracétamol pédiatrique rétrogradés (pas de pic 2026 ANSM-confirmé) ; (e) eau embouteillée rétrogradée 🟡 ; (f) power banks rétrogradés 🟢→🟡 ; (g) fiches 5.4.1 (paracétamol) et 5.4.3 (sartans) annotées « Mise à jour 2.1 » ; (h) **nouvelle fiche 5.4.4-bis Lévothyroxine** complète. **Confiance globale** : maintenue ★★★★. |
...
| **15 juillet 2026 (J138)** | **3.0 (recalage)** | OSINT Ormuz | **Recalage post-vérification via [synthese_J135-J138.md](synthese_J135-J138.md)** : **correctif Brent** — clôture réelle du 13/7 = **83,30 $ (+9,59 %)** et non 79,02 $ (source unique erronée), puis 84,73 $ (14/7) et >85 $ en séance (15/7), backwardation 8,92 $ — **le seuil de choc 85-90 $ est atteint en borne basse** ; **gazole France 2,003 €/L (15/7, AFP) — repasse 2 €/L**, 5 % des stations en difficulté (pas de pénurie) ; **probabilités recalées : C 45-55 % (modal renforcé), B 28-38 %, A 5-12 %** ; faits nouveaux à intégrer à la prochaine édition : blocus naval réimposé (14/7), 3 pétroliers frappés en un jour (JMIC « SEVERE »), MOU dénoncé déclarativement par Téhéran, **interdiction chinoise d'export d'hélium (10/7)**, urée 422,50 $/t (détente confirmée), distillats US +4,6 mb (première détente), embargo diesel russe jusqu'au 31/7. Paliers et dates butoirs inchangés (le recalage prix ne modifie pas les mécanismes ; révision hebdomadaire du lundi 20/7 à confirmer). |
| **18 juillet 2026 (J141)** | **3.0 (recalage probabilités)** | OSINT Ormuz | **Recalage via [synthese_J138-J141.md](synthese_J138-J141.md)** : **probabilités C 52-60 % (modal renforcé, médiane ~56), B 27-36 %, A 4-10 %** ; le corridor escorté ne se matérialise pas (8 navires/j les 16-17/7, majorité route iranienne, brut/condensats 4,1 Mb/j, −62 %), **prime Dated Brent physique réapparue** (+1,30 $, 16/7), **GL X1 expirée le 17/7**, 2ᵉ marin civil tué (VLCC *Mombasa B*), **crack diesel européen record ~66 $**, Brent 88,10 $ (clôture 17/7) ; **gazole France 2,05-2,07 €/L** (17/7), ~4 % des stations en difficulté (en amélioration). **Trajectoire centrale C et paliers S29→S40 inchangés** (le recalage probabilités ne modifie pas les mécanismes). |
