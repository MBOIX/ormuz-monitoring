...
## Trajectoire centrale : Scénario C (Escalade / guerre d'usure — modal, 45-55 % à J138) — Période S29 → S40 (13 juillet → 4 octobre 2026)
...
| Paramètre | Valeur |
|---|---|
| **Scénario de référence** | **C — Escalade / guerre d'usure (modal renforcé : 45-55 % au 15 juillet 2026, J138**, [scenario_pessimiste.md](scenario_pessimiste.md)) ; bornes : B — Enlisement / corridor militarisé stabilisé 28-38 % ([scenario_realiste.md](scenario_realiste.md)), A — Accord durable 5-12 % ([scenario_optimiste.md](scenario_optimiste.md)). **NB : « C modal » = guerre d'usure durable avec Ormuz fermé/dangereux et prix qui cotent (c'est désormais le cas : Brent >85 $) — PAS la guerre totale ni un Brent > 150 $. C'est une fourchette (45-55 %), pas une certitude : la lecture B (Annexe C) reste plausible.** En cas de re-capage confirmé (corridor omanais accepté, session de Doha tenue, transits AIS durablement > 40/j), basculer sur la lecture B de l'Annexe C. |
...
| **Date d'édition** | **13 juillet 2026 (J136 du conflit Ormuz) — Édition 3.0** ; probabilités, Brent et gazole recalés le **15 juillet 2026 (J138)** via [synthese_J135-J138.md](synthese_J135-J138.md) |
...
> **Document prévisionnel sous trajectoire centrale C (scénario modal renforcé à J138 : 45-55 %) — une fourchette, pas une certitude.** La borne moins sévère (B — corridor militarisé stabilisé, porté par la médiation Pakistan-Qatar-Oman et le double corridor omanais, 28-38 %) et la borne de détente (A — accord durable, 5-12 %, très improbable) sont traitées en **Annexe C**. Trois mécanismes de la fenêtre sont **indépendants de l'issue Ormuz** et s'appliquent sous B comme sous C : la tension mondiale sur les distillats (exports diesel russes suspendus, crack spread record), le choc climatique café (Brésil) et les tensions médicaments préexistantes (ANSM). Voir [scenario_pessimiste.md](scenario_pessimiste.md) et [scenario_realiste.md](scenario_realiste.md) pour les signaux de bascule.
>
...
**⭐ Lecture rapide au 13 juillet (J136), recalée au 15 juillet (J138) — Édition 3.0 (fenêtre 12 semaines, C modal 45-55 %, verdict marchés corrigé : Brent +9,6 % puis >85 $, gazole >2 €/L — le choc de prix est enclenché)** :
...
> Lecture : chaque cellule indique le palier dominant attendu en fin de semaine considérée, **sous trajectoire centrale C (modal renforcé, 45-55 % à J138)**. `→` indique une bascule probable au cours de la semaine. `*` = risque **localisé/intermittent ou tarifaire** (le seuil 🔴 « disponibilité < 30 %, rupture > 2 semaines » n'est PAS attendu à l'échelle nationale — annotation issue de la relecture adversariale).
...
Ce calendrier est rédigé sous la **trajectoire centrale C (modal renforcé, 45-55 % à J138)**. Les paliers et dates butoirs ci-dessus intègrent déjà la prudence — il n'y a **pas** de « lecture pire » à appliquer par défaut. Pour les bornes moins sévères :

### Sous le scénario B — Enlisement / corridor militarisé stabilisé (28-38 %, nettement derrière C depuis J138)
...
### Sous le scénario A — Accord durable (5-12 %, très improbable)
