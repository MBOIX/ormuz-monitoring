...
**26 juin 2026 (J119) — actualisation moyen-long terme au 8 juillet 2026 (J131)**

> **À lire d'abord.** Ce document suit les impacts de la crise du détroit d'Ormuz (déclenchée le 28 février 2026, J1) sur **toute la chaîne alimentaire** : intrants (engrais, soufre, carburant agricole, AdBlue, énergie de production), production agricole, fret céréalier, sécurité alimentaire mondiale, transformation et prix au consommateur — jusqu'à l'assiette française. Chaque élément porteur est **étiqueté** `[FAIT]` (observé/sourcé), `[INTERPRÉTATION]` (déduction) ou `[SPÉCULATION]` (hypothèse), et **coté** au système Admiralty/STANAG 2511 (lettre A→F = fiabilité de la source ; chiffre 1→6 = crédibilité de l'information). Les vides documentaires sont assumés en fin de document, jamais comblés par une estimation déguisée en certitude. **Cadre de cohérence (actualisé J131)** : l'accord-cadre US-Iran de juin est désormais **fracturé** par la rechute du 7-8 juillet (frappes directes US↔Iran, 3 navires frappés par le CGRI, licence pétrolière US révoquée, cessez-le-feu déclaré « terminé » par Trump) — **sans nullité juridique du MOU ni mort rapportée** ; la normalisation physique d'Ormuz reste non acquise et **plus incertaine qu'à J119**. La synthèse périodique la plus récente (`synthese_J119-J131.md`) fait foi sur l'état courant. **Le corps détaillé ci-dessous reste un instantané chiffré au 26 juin (J119)** ; les évolutions moyen-long terme pour la France sont résumées dans l'actualisation J131 juste après.

---

> **⏩ Actualisation J131 (8 juillet 2026) — ce qui bouge à moyen-long terme pour la France.** Sur la chaîne alimentaire, trois lignes de fond se déplacent depuis le 26 juin :
...
> - **Scénarios recalibrés** : le calendrier prospectif ci-dessous était ancré sur **B (35-45 %)** avec bifurcations A (40-50 %) / C (12-18 %) ; à J131, c'est **B 33-43 % / A 15-25 % / C 32-42 %** — la branche **C (Ormuz refermé, gaz tendu) a fortement gagné en probabilité**, ce qui rend la « normalisation 2027 » des engrais (qui dépend de A) **nettement moins probable** qu'à J119.
...
> `[SPÉCULATION]` **Avertissement** : au-delà des deux prochains trimestres, toute trajectoire est **massivement spéculative**. Ce calendrier est **ancré sur le scénario central B** (enlisement, **33-43 % au J131**), avec bifurcations vers **A** (accord durable, **15-25 %** — normalisation plus rapide) et **C** (escalade/choc, **32-42 %** — aggravation). **MAJ J131** : après la rechute du 7-8 juillet, **C a fortement gagné** (l'escalade militaire directe US↔Iran est redevenue réelle) et **A s'est effondré** — la bifurcation défavorable est désormais **presque aussi probable que le chemin central**, et la « normalisation 2027 » qui dépend de A est nettement moins probable. Les bilans céréaliers 2026/27 cités sont **en grande partie d'origine climatique et antérieurs à Ormuz** : ne pas les imputer principalement au détroit (erreur de causalité).
