...
> `[SPÉCULATION]` **Avertissement** : au-delà des deux prochains trimestres, toute trajectoire est **massivement spéculative**. Ce calendrier est **ancré sur le scénario central B** (enlisement, **30-40 % au J135 — qui n'est plus le scénario modal**), avec bifurcations vers **A** (accord en mort clinique, **8-15 %** — normalisation rapide très improbable) et **C** (escalade/choc, **40-50 % — scénario modal depuis J135** — aggravation). **MAJ J135** : après la bascule du 8-12 juillet (seuil létal franchi, Ormuz déclaré « fermé », transits effondrés), **la bifurcation défavorable C est devenue le chemin le plus probable** — la « normalisation 2027 » qui dépend de A est très improbable, et la colonne C constitue la lecture prudente du calendrier. Les bilans céréaliers 2026/27 cités sont **en grande partie d'origine climatique et antérieurs à Ormuz** : ne pas les imputer principalement au détroit (erreur de causalité).
